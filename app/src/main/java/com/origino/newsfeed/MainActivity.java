...
import com.origino.newsfeed.Adapters.NewsAdapter;
import com.origino.newsfeed.Models.NewsModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent()!= null && getIntent().getExtras()!= null)
        {
            if(getIntent().getExtras().getString("source_id")!= null && !getIntent().getExtras().getString("source_id").isEmpty()) {
                ...
                url = "https://newsapi.org/v2/top-headlines?sources=" + source_id + "&apiKey=9c69285c088c46608e5b68b71508aafb";
            }
            else if(getIntent().getExtras().getString("category")!= null && !getIntent().getExtras().getString("category").isEmpty())
            {
                String category = getIntent().getExtras().getString("category");
                title.setText(category);
                url = "https://newsapi.org/v2/top-headlines?category=" + category + "&apiKey=9c69285c088c46608e5b68b71508aafb";
